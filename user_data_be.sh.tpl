...
docker pull 634612353979.dkr.ecr.${region}.amazonaws.com/eschool-backend:latest;
docker run -d -p 8080:8080 634612353979.dkr.ecr.${region}.amazonaws.com/eschool-backend:latest;
